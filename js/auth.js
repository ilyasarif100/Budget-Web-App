 ...
 * @param {string|null} token - The authentication token to store, or null to remove
 * @returns {void}
 */
...
/**
 * Makes an authenticated HTTP request with automatic token handling, caching, and deduplication
...
async function authenticatedFetch(url, options = {}) {
  ...
  const fetchFn =
    typeof window !== 'undefined' && window.deduplicatedFetch ? window.deduplicatedFetch : fetch;
