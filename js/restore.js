 ...
 * @returns {{isValid: boolean, errors: string[]}} Validation result with isValid flag and array of error messages
 */
 ...
 * @param {File} file - File object from file input
 * @param {string} [strategy='replace'] - Restore strategy: 'replace' or 'merge'
 * @returns {Promise<void>} Resolves when import and restore are complete
 * @throws {Error} If import or restore fails
 */
